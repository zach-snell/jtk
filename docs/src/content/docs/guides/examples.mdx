...
<Aside type="tip">
When using MCP, the AI agent has access to all 10 tools simultaneously. It can chain operations naturally — search for issues, get details, check dev info, and create comments — all in a single conversation.
</Aside>
